...
\hypersetup{colorlinks,breaklinks,
            linkcolor=wine,urlcolor=wine,
            anchorcolor=wine,citecolor=wine}
...
University of Maryland College Park \hfill \href{https://asilvub.github.io/}{https://asilvub.github.io/} \\
...
\textbf{Research Interests: } International Macroeconomics and Trade
...
``Business Cycle Asymmetry and Input-Output Structure: The Role of Firm-to-Firm Networks"\\
 with Jorge Miranda-Pinto and Eric R. Young.\\
  R\&R Journal of Monetary Economics\\[-0.1in]

``Commodity Shocks and Production Networks in Small Open Economies"\\
 with Petre Caraiani, Jorge Miranda-Pinto, and Juan Olaya-Agudelo.

\section*{Work in Progress}

``Sectoral Demand Shocks and Inflation in Small Open Economies''\\[-0.1in]

``Career Effects of Working at a Startup"\\
 with Gonzalo Garc\'ia-Trujillo and Nathalie Gonz\'alez-Prieto.\\[-0.1in]
...
Forthcoming. American Economic Association, Papers \& Proceedings. 2023.\\[-0.1in]

``Global Supply Chain Pressures, International Trade and Inflation"\\
with Julian di Giovanni, \c{S}ebnem Kalemli-\"{O}zcan, and Muhammed A. Y{\i}ld{\i}r{\i}m. \\
Conference Proceedings ECB Forum: ``Challenges for Monetary Policy in a Rapidly Changing World'', 2022.\\[-0.1in]
...
Latin American Policy Journal, Volume 7, Spring: pp. 68-73. 2018.\\[-0.1in]

``School Funding in Chile"\\
 with Sergio Urz\'ua \\
In Ideas en Educaci\'on II: Definiciones en Tiempos de Cambio, Chapter 7 (In Spanish). 2018.

\section*{Professional Activities}
\emph{Referee Work: } Economic Letters, Econom\'ia (LACEA), Ecos de Econom\'ia.
%\section*{Referee Work}
%\textbf{Referee Work: } Economic Letters, Econom\'ia (LACEA), Ecos de Econom\'ia.

\emph{Conference Presentations by Me (since 2021)}: 
Maryland Macro Brown Bag (x2), NBER IFM Meeting Fall 2022\\
\emph{By Coauthors}: ASSA, Carnegie-Rochester-NYU Conference in Public Policy (2022), NBER EFG Meeting Fall (2022), LACEA-LAMES Annual Conference, Universidad de Chile, Central Bank of Chile.\\
\emph{Invited Seminar Presentations}: Bielefeld Trade Group 
