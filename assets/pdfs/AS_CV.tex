...
\section*{Publications ({\footnotesize $^{**}$ denotes Pre-Ph.D. Work})}
...
\underline{Conferences} ({\footnotesize $^\ast$ participated in conference but coauthor presented.})
