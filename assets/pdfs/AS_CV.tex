...
\indent Economist, August 2024 -- 
\fi 
\section*{Education}
 University of Maryland College Park\\
\indent Ph.D. in Economics, 2024\\
\indent \indent \emph{Committee: \c{S}ebnem Kalemli-\"{O}zcan (Chair), Pierre de Leo, Thomas Drechsel, Julian di Giovanni}\\
...
\noindent \textbf{Inflation in Disaggregated Small Open Economies}\\[-0.125in]

    \noindent \textbf{Commodity Prices and Production Networks in Small Open Economies}, with Petre Caraiani, Jorge Miranda-Pinto, and Juan Olaya-Agudelo\\[-0.125in]

\noindent \textbf{Startup Employment and Career Trajectories}, with Gonzalo Garc\'ia-Trujillo and Nathalie Gonz\'alez-Prieto\\[-0.125in]

\noindent \textbf{Pandemic-Era Inflation Drivers and Global Spillovers}, with Julian di Giovanni, \c{S}ebnem Kalemli-\"{O}zcan, and Muhammed A. Y{\i}ld{\i}r{\i}m
...
\noindent \textbf{Optimal Monetary and Exchange Rate Policy in Disaggregated Small Open Economies}\\[-0.125in]
...
\section*{Published and Forthcoming Papers ($\mathcal{P}$: Pre-Ph.D.)}
\iffalse
...
\begin{enumerate}[wide, labelwidth=!, labelindent=0pt]
 \item \textbf{Business Cycle Asymmetry and Input-Output Structure: The Role of Firm-to-Firm Networks}, with Jorge Miranda-Pinto and Eric R. Young, \emph{Journal of Monetary Economics,} 2023\\[-0.125in]

%\subsection*{Peer-Reviewed Publications}
\item \noindent \textbf{Quantifying the Inflationary Impact of Fiscal Stimulus Under Supply Constraints}, with Julian di Giovanni, \c{S}ebnem Kalemli-\"{O}zcan, and Muhammed A. Y{\i}ld{\i}r{\i}m, \emph{AEA Papers \& Proceedings}, 2023\\[-0.125in]

\item \noindent \textbf{Global Supply Chain Pressures, International Trade and Inflation}, with Julian di Giovanni, \c{S}ebnem Kalemli-\"{O}zcan, and Muhammed A. Y{\i}ld{\i}r{\i}m. {\emph{Conference Proceedings Sintra ECB Forum}, 2022}\\[-0.125in]

\item \noindent \textbf{Price Controls, Hyperinflation, and the Inflation-Relative Price Variability Relationship}, with Rodrigo Cerda and Rolf L\"{u}ders, \emph{Empirical Economics}, 2021. ($\mathcal{P}$)\\[-0.125in]

\item \noindent \textbf{Impact of Economic Uncertainty in a Small Open Economy: The Case of Chile}, with Rodrigo Cerda and Jos\'e Tom\'as Valente, \emph{Applied Economics}, 2018. ($\mathcal{P}$)\\[-0.125in]

%\subsection*{Non-Refereed, Invited Publications, Book Chapters and Others}


\item \noindent \textbf{Towards Measuring Economic Policy Uncertainty in Latin America: A First Little Step}, \emph{Latin American Policy Journal}, 2018. ($\mathcal{P}$)\\[-0.125in]
\end{enumerate}
