...
\noindent ``Inflation in Disaggregated Small Open Economies'' (Job Market Paper)\\[-0.125in]
...
\indent with Julian di Giovanni, \c{S}ebnem Kalemli-\"{O}zcan, and Muhammed A. Y{\i}ld{\i}r{\i}m\\[-0.125in]
