...
\noindent ``Price Controls, Hyperinflation, and the Inflation-Relative Price Variability Relationship"\\
\indent with Rodrigo Cerda and Rolf L\"{u}ders. \\
\indent \textbf{Empirical Economics}, \emph{61}(4), pp. 1725--1748. 2021. ($\mathcal{P}$)\\[-0.125in]
...
\indent \textbf{Applied Economics}, \textit{50}(26), pp. 2894 - 2908. 2018. ($\mathcal{P}$)\\[-0.125in]
...
\indent \textbf{Latin American Policy Journal}, Volume 7, Spring: pp. 68-73. 2018. ($\mathcal{P}$)\\[-0.125in]

\noindent ``School Funding in Chile"\\
\indent with Sergio Urz\'ua \\
\indent { In  \textbf{Ideas en Educaci\'on II: Definiciones en Tiempos de Cambio}, Chapter 7 (In Spanish). 2018. ($\mathcal{P}$) }
\newpage 
