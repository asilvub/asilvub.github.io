...
\noindent {\itshape Universidad de Concepci\'on, Chile}\\
...
\indent \textit{Journal of Monetary Economics,} Forthcoming\\[-0.125in]
...
\indent \textit{American Economic Association, Papers \& Proceedings}, Forthcoming\\[-0.125in]
...
\section*{Invited Seminar and Conference Presentations (since 2022)}

\noindent 
\emph{Invited Seminars}\\[0.1in]
\begin{tabular}{@{}lp{15.5cm}}
2023& Central Bank of Brazil ($O$)\\
2022& Bielefeld University Trade Group ($O$)%\\
...
\begin{tabular}{@{}lp{15.5cm}}
2023& ASSA ($^\ast$)\\
2022& NBER IFM Meeting Fall, Carnegie-Rochester-NYU Conference in Public Policy ($^\ast$), NBER EFG Meeting Fall ($^\ast$)
\end{tabular}
...
{\footnotesize $^\ast$: participated in conference but coauthor presented. $O$: online presentation.}
...
Federal Reserve Board Dissertation Fellow, Summer 2023  (Scheduled)\\
NBER Graduate Student Workshop on Heterogeneous-Agent Macroeconomics,  Summer 2023 (Scheduled)\\
