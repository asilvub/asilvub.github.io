...
\begin{tabular}{@{}p{1.8cm}p{13cm}}
    2025 -- & Affiliate, Global Linkages Lab, Brown University
\end{tabular}
...
\begin{tabular}{@{}p{1.8cm}p{13cm}}
   ...
   & \small Committee: \c{S}ebnem Kalemli-\"{O}zcan (Chair), Pierre de Leo, Thomas Drechsel, Julian di Giovanni\\
    ...
    2014 -- 2016 & M.Sc. in Applied Economics (with honors), Universidad de Concepci\'on, Chile\\
    2009 -- 2013 & B.Sc. in Economics (with honors), Universidad de Concepci\'on, Chile
\end{tabular}
...
\noindent ``Trade Wars on the Income Statement: The Effects of Tariffs on Firms", with Barbiero, Sheremirov, and Stein\\[-0.125in]
...
\noindent ``The Contribution of Imports to Domestic Prices'', with Barbiero and Stein\\[-0.125in]


\noindent ``Intergenerational Heterogeneity in Real Measures: A Migration Story'', with Navarrete\\[-0.125in]
...
\noindent ``School Funding in Chile", with Sergio Urz\'ua. \emph{Ideas en Educaci\'on II: Definiciones en Tiempos de Cambio}, Chapter 7 (In Spanish), 2018
...
%\begin{small}
\begin{tabular}{@{}p{1.8cm}p{13cm}}
2025 & Central Bank of Chile\\
2024& Bank of Canada, University of Chile, Pontificia Universidad Cat\'olica de Chile, Fed Board, Boston Fed\\
2023& Fed Board, Central Bank of Brazil ($\mathcal{O}$), Labor, Firms, and Macro Group ($\mathcal{O}$)\\
...
\begin{tabular}{@{}p{1.8cm}p{13cm}}
2026 & System Comittee on International Economic Analysis (SCIEA, $\mathcal{S}$), BEAR Conference ($\mathcal{C}$), Midwest Macro ($\mathcal{S}$), Barcelona GSE Summer Forum ($\mathcal{S}$), CEBRA Annual Meeting ($\mathcal{S}$), SED ($\mathcal{S}$)\\
2025 & NBER Summer Institute IFM Group ($\mathcal{C}$)\\
...
\begin{tabular}{@{}p{1.8cm}p{13cm}}
2025 & SCIEA, CEBRA Annual Meeting.
\end{tabular}
...
\begin{tabular}{@{}p{1.8cm}p{13cm}}
    Referee & JME, JIE, AEJ Macro, ReStat, EER, JEDC, JFQA, Journal of Macroeconomics, Economic Letters, Econom\'ia (LACEA), The World Economy, Macroeconomic Dynamics, Emerging Markets Review\\
