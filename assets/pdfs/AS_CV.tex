...
\noindent \textbf{``Inflation in Disaggregated Small Open Economies"}\\[-0.125in]
    ...
    \noindent \textbf{``Commodity Prices and Production Networks in Small Open Economies"}", with Caraiani, Miranda-Pinto, and Olaya-Agudelo\\[-0.125in]

\noindent \textbf{``Startup Employment and Career Trajectories"}, with Garc\'ia-Trujillo and Gonz\'alez-Prieto\\[-0.125in]

\noindent \textbf{``Pandemic-Era Inflation Drivers and Global Spillovers"}, with di Giovanni, Kalemli-\"{O}zcan, and Y{\i}ld{\i}r{\i}m
...
\begin{enumerate}[wide, labelwidth=!, labelindent=0pt]
 \item \textbf{``Business Cycle Asymmetry and Input-Output Structure: The Role of Firm-to-Firm Networks"}, with Miranda-Pinto and Young, \emph{Journal of Monetary Economics,} 2023\\[-0.125in]

%\subsection*{Peer-Reviewed Publications}
\item \noindent \textbf{``Quantifying the Inflationary Impact of Fiscal Stimulus Under Supply Constraints"}, with di Giovanni, Kalemli-\"{O}zcan, and Y{\i}ld{\i}r{\i}m, \emph{AEA Papers \& Proceedings}, 2023\\[-0.125in]

\item \noindent \textbf{``Global Supply Chain Pressures, International Trade and Inflation"}, with di Giovanni, Kalemli-\"{O}zcan, and Y{\i}ld{\i}r{\i}m. {\emph{Conference Proceedings Sintra ECB Forum}, 2022}\\[-0.125in]

\item \noindent \textbf{``Price Controls, Hyperinflation, and the Inflation-Relative Price Variability Relationship"}, with Cerda and L\"{u}ders, \emph{Empirical Economics}, 2021. ($\mathcal{P}$)\\[-0.125in]

\item \noindent \textbf{``Impact of Economic Uncertainty in a Small Open Economy: The Case of Chile"}, with Cerda and Valente, \emph{Applied Economics}, 2018. ($\mathcal{P}$)\\[-0.125in]
