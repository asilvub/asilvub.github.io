...
\begin{small}
\begin{tabular}{@{}lp{15.5cm}}
2023& ASSA ($\mathcal{C}$), Bank of Finland and CEPR Joint Conference on Monetary Policy in Times of Large Shocks ($\mathcal{C}$), Washington Area Network Economics Symposium (scheduled), CEBRA Workshop for Commodities and Macroeconomics (scheduled)\\
