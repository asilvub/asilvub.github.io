...
\noindent ``Startup Employment and Career Trajectories", with Garc\'ia-Trujillo and Gonz\'alez-Prieto\\[-0.125in]

\noindent ``Pandemic-Era Inflation Drivers and Global Spillovers", with di Giovanni, Kalemli-\"{O}zcan, and Y{\i}ld{\i}r{\i}m
...
\section*{Services}
Referee for:  \emph{Journal of Monetary Economics, Journal of Macroeconomics, Economic Letters, Econom\'ia (LACEA)}.\\
Reviewer for: Fondecyt Chile.
