...
\emph{Primary}: International Macroeconomics and Trade\\
...
\emph{Invited Seminar Presentations by Me}: Bielefeld Trade Group (Online)\\
\emph{Conference Presentations By Coauthors}: ASSA, Carnegie-Rochester-NYU Conference in Public Policy (2022), NBER EFG Meeting Fall (2022), LACEA-LAMES Annual Conference, Universidad de Chile, Central Bank of Chile.
