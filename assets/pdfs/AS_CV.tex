...
\noindent ``US Firms Exposure to Tariffs: A Comparison of the 2018 and 2025 Episodes", with Barbiero, Sheremirov, and Stein\\[-0.125in]
...
\noindent ``The Contribution of Imports to Consumer Prices'', with Barbiero and Stein\\[-0.125in]
...
\begin{tabular}{@{}p{1.8cm}p{13cm}}
2026 & Midwest Macro ($\mathcal{S}$), Barcelona GSE Summer Forum ($\mathcal{S}$), SED ($\mathcal{S}$)\\
...
\begin{tabular}{@{}p{1.8cm}p{13cm}}
2025 &System Comittee on International Economic Analysis, CEBRA Annual Meeting.
\end{tabular}
...
\begin{tabular}{@{}p{1.8cm}p{13cm}}
    Referee & Journal of Monetary Economics, Journal of International Economics, European Economic Review, Journal of Economic Dynamics and Control, Journal of Financial and Quantitative Analysis, Journal of Macroeconomics, Economic Letters, Econom\'ia (LACEA), The World Economy, Emerging Markets Review, Macroeconomic Dynamics\\
