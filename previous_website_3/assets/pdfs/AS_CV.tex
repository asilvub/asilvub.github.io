...
\indent with Alvaro Castillo, Luis F. C\'espedes, and Jorge Miranda-Pinto\\[-0.125in]

%\noindent ``Pandemic-Era Inflation Drivers and Global
%Spillovers"\\
%\indent with Julian di Giovanni, \c{S}ebnem alemli-\"{O}zcan, and Muhammed A. Y{\i}ld{\i}r{\i}m
...
\begin{small}
\begin{tabular}{@{}lp{15.5cm}}
2023& ASSA ($\mathcal{C}$), Bank of Finland and CEPR Joint Conference on Monetary Policy in Times of Large Shocks ($\mathcal{C}$), ERMAS ($\mathcal{C}$), Washington Area Network Economics Symposium (scheduled), CEBRA Workshop for Commodities and Macroeconomics (scheduled), \\
